                                ...
                                <table className="table table-borderless bg-light table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        return (
                                            <tr>
                                                <td key={index}>
                                                    <input type="checkbox" value={post.email}  onClick={(e) => {
                                                        setEmail(e.target.value);
                                                        setSupp(supp => [...supp, email])
                                                        console.log(supp);
                                                    }} />
                                                </td>
                                                <td key={index+1}><span className="bg-bdark">{post.nom}</span></td>
                                                <td key={index+2}><span className="bg-blight">{post.email}</span></td>
                                                <td key={index+3}><span className="bg-bdark">{post.numTel}</span></td>
                                                <td className="text-center px-0" key={index+4}><span className="bg-bdark">{post.titre}</span></td>
                                                <td className="text-center" key={index+5}> 
