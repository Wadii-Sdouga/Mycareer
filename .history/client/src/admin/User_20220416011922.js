            ...
            <div className="carde">
                <div className="card-header">
                        ...
                        <div id="credit-card" className="tab-pane fade show active pt-3">
                            <form role="form" onsubmit="event.preventDefault()">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" name="cardNumber" placeholder="Valid card number" className="form-control "  />
                                        <div className="input-group-append"> <span className="input-group-text text-muted"> <i className="fab fa-cc-visa mx-1"></i>
                                         <i className="fab fa-cc-mastercard mx-1"></i> <i class="fab fa-cc-amex mx-1"></i> </span> </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group"> <label><span className="hidden-xs">
                                                    <h6>Expiration Date</h6>
                                                </span></label>
                                            <div class="input-group"> <input type="number" placeholder="MM" name="" className="form-control"  /> 
                                            <input type="number" placeholder="YY" name="" className="form-control"  /> </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                    ...
                    <div id="paypal" class="tab-pane fade pt-3">
                        ...
                        <div class="form-group "> <label class="radio-inline"> <input type="radio" name="optradio"  /> Domestic </label> <label class="radio-inline"> 
