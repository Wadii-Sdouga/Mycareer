                                            ...
                                            (
                                                <tr key={index} >
                                                    ...
                                                    <td className="text-center" >
                                                        ...
                                                        setView(view => [...view, current.current])
                                                        Viewprofil();
                                                        console.log(view);  }}value={post} > <i className="zmdi zmdi-eye"></i></button>
                                                                    ...
                                                                    <div class="row m-l-0 m-r-0">
                                                                        <div class="col-sm-4 bg-c-lite-green user-profile ">
                                                                            <div class="card-block text-center text-white ">
                                                                                ...
                                                                                <h6 class="f-w-600">{post.nom}</h6>
                                                                                <p>{post.titre}</p> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-8">
                                                                            <div class="card-block">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <h6 class="text-muted f-w-400">{post.email}</h6>
                                                                                    </div>
                                                                                    <div class="col-sm-6">
                                                                                        <p class="m-b-10 f-w-600">Phone</p>
                                                                                        <h6 class="text-muted f-w-400">{post.numTel}</h6>
                                                                                    </div>
                                                                                </div>
