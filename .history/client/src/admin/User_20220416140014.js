                                                    ...
                                                    <div class="col-lg-7 mx-auto">
                                                        <div class="bg-white rounded-lg shadow-sm p-5">
                                                            ...
                                                            <div class="tab-content p-5">
                                                                ...
                                                                <div class="row ">
                                                                    <div class="col-sm-8 ">
                                                                        <div class="form-group pt-5 " >
                                                                            ...
                                                                            <select class="form-select form-select-lg mb-3 border-5" aria-label=".form-select-lg example" name="format" >
                                                                ...
                                                                <button type="button" class="  btn-primary btn-block rounded-pill shadow-sm"> Confirm  </button>
