                                        ...
                                        return (
                                            <tr key={index} >
                                                ...
                                                <td className="text-center" >
                                                    <form onSubmit={console.log(current.current)}>     
                                                    <button type="submit"  onClick={() => { current.current=post.email ; }}  > <i className="zmdi zmdi-delete"></i></button>
                                                    </form> 
