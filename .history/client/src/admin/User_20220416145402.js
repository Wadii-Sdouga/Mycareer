                    ...
                    <div className="d-md-flex">
                        <div className="topSidebar  w-100">
                            ...
                            <div className="d-flex align-items-center mb-3 px-md-3 px-2">
                                ...
                                <button type="submit" className='ml-5' onClick={() => { togglePopup1(); }}><i className="zmdi zmdi-plus "></i></button>
                                                    ...
                                                    <div class="col-lg-7 mx-auto">
                                                        <div class="bg-white rounded-lg shadow-sm p-5">
                                                            ...
                                                            <div class="tab-content p-5">
                                                                ...
                                                                <input type="text" name="cardNumber" placeholder="siasir le nom du technologie" class="form-control" />
                                                                <div class="row ">
                                                                    <div class="col-sm-8 ">
                                                                        <div class="form-group pt-5 " >
                                                                            ...
                                                                            <select class="form-select form-select-lg  mb-3 border-5" aria-label=".form-select-lg example" name="format" onChange={(e) => {setFormat(e.target.value)}} >
                                                                                <option selected className='w-500'>choisir carriére</option>
                                                                                {
                                                                    add.map((post, i) => {
                                                                        i += 1;
                                                                     
                                                                            return (
                                                                                <option value={post.titre}>{post.titre}</option>   )
                                                                            })}
                                                                ...
                                                                <button type="button" class="  btn-primary btn-block rounded-pill shadow-sm" onClick={AddTech}> Confirm  </button>
