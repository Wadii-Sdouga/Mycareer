                                ...
                                <table className="table table-borderless bg-light table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        return (
                                            <tr>
                                                <td key={index}>
                                                    <input type="checkbox" value={post.email}  key={index} onClick={(e) => {
                                                        setEmail(e.target.value);
                                                        setSupp(supp => [...supp, email])
                                                        console.log(supp);
                                                    }} />
                                                </td>
                                                <td key={index}><span className="bg-bdark">{post.nom}</span></td>
                                                <td key={index}><span className="bg-blight">{post.email}</span></td>
                                                <td key={index}><span className="bg-bdark">{post.numTel}</span></td>
                                                <td className="text-center px-0" key={index}><span className="bg-bdark">{post.titre}</span></td>
