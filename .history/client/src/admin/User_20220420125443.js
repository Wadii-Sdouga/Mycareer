                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 mx-auto">
                                                <div class="bg-white rounded-lg shadow-sm p-5">
                                                    ...
                                                    <ul role="tablist" class="nav bg-light nav-pills rounded-pill nav-fill mb-3">
                                                        <li class="nav-item">
                                                            <a data-toggle="pill" href="#nav-tab-card" class="nav-link  rounded-pill" onClick={() => {
                                                                togglePopup3();
                                                            }}>
                                                            Ajouter Technologie
                                                            </a>
                                                        ...
                                                        <li class="nav-item">
                                                            <a data-toggle="pill" href="#nav-tab-paypal" class="nav-link active rounded-pill" onClick={() => {
                                                                togglePopup4();
                                                            }}>
                                                               Ajouter Carriére
                                                            </a>
