...
function AdminCar() {
    ...
    const Viewprofil = async (s) => {
        try {
            const response = await api.post('http://localhost:5000/admin/view/profil',{email:current.current.email});
                                                                        ...
                                                                        <div className="row m-l-0 m-r-0">
                                                                            <div className="col-sm-4 bg-c-lite-green user-profile ">
                                                                                <div className="card-block text-center text-white ">
                                                                                    ...
                                                                                    <h6 className="f-w-600">{current.current.nom}</h6><i class=" zmdi zmdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
