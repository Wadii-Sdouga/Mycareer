                                            ...
                                            (
                                                <tr key={index} >
                                                    ...
                                                    <td className="text-center" >
                                                        ...
                                                        <button type="submit" value={post.email} onClick={() => { togglePopup2(); }}  > <i className="zmdi zmdi-delete"></i> </button>
...
< br />
                    ...
                    {op && <Popup2
                                    ...
                                    <button type="button" class="btn btn-danger mr-5">Supprimer</button>
