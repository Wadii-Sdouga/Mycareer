                    ...
                    <div className="d-md-flex">
                        <div className="topSidebar  w-100">
                            ...
                            <div className="d-flex align-items-center mb-3 px-md-3 px-2">
                                ...
                                <button type="submit" className='ml-5' onClick={() => {
                                                            togglePopup();
                                                          

                                                        }}><i className="zmdi zmdi-plus "></i></button>
                                <button type="submit" className='ml-5'><i className="zmdi zmdi-plus "></i></button>
                                                ...
                                                <div className="row m-l-0 m-r-0">
                                                    ...
                                                    <div className="col-sm-8">
                                                        <div className="card-block">
                                                            ...
                                                            <div className="row">
                                                                <div className="col-sm-6">
                                                                    <p className="m-b-10 f-w-600">wadii</p>
                                                                    <h6 className="text-muted f-w-400">{current.current.email}</h6>
                                                                </div>
                                                                <div className="col-sm-6">
                                                                    <p className="m-b-10 f-w-600">Phone</p>
