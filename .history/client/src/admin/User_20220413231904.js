                                                                        ...
                                                                        <div className="row m-l-0 m-r-0">
                                                                            <div className="col-sm-4 bg-c-lite-green user-profile ">
                                                                                <div className="card-block text-center text-white ">
                                                                                    ...
                                                                                    <h6 className="f-w-600">{current.current.nom}</h6><i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                                                                                    <p>{current.current.titre}</p> <i className=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                                                                                </div>
                                                                            </div>
