                                                                ...
                                                                <div class="row ">
                                                                    <div class="col-sm-8 ">
                                                                        <div class="form-group pt-5 " >
                                                                            ...
                                                                            <select class="form-select form-select-lg col-lg-10 mb-3 border-5" aria-label=".form-select-lg example" name="format" onChange={(e) => {setFormat(e.target.value)}} >
                                                                                <option selected>choisir carriére</option>
                                                                                {
                                                                    add.map((post, i) => {
                                                                        i += 1;
