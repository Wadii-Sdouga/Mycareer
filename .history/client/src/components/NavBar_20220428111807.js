...
function Navbar() {
    ...
    return (
        <nav class="navbar navbar-light navbar-expand  shadow  static-top ">
                                ...
                                <img class="border rounded-circle img-profile" src={avatar} />
                                    ...
                                    <div class="dropdown-content">
                                        <ul>
                                            ...
                                            <li><i class='bx bx-user'></i><span>Profiles</span></li>
                                            <li><i class='bx bx-cog'></i><span>Inbox</span></li>
                                            <li><i class='bx bx-cog'></i><span>Help</span></li>
                                            <li><i class='bx bx-log-in-circle'></i><span>Logout</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
