...
function Carriere() {
    ...
    const handleChange = () => {
      ...
      curent.current.map(()=>{
        ...
        var a=curent.current[index].niv;
        var b=curent.current[index].techno;
        console.log(a);
        console.log(b);
         api.post('/carriere', {
            a,
                    ...
                    <div className='navi'>
                        ...
                        <div id="topSideBar" className="text-center">
                            ...
                            <div className="table-responsive px-2">
                                ...
                                <a  className='text-center'> <button className='btn bg-info'  onClick={handleChange}>Rates</button></a>
                            </div>
                            < br />
                        </div>
                    </div>
