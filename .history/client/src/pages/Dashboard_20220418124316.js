...
function Dashboard() {
    ...
    const getData2 = async () => {
        try {
            const response = await api.get('http://localhost:5000/dashboard2');
    ...
    return (
        <div clasName=" container bg-info">
            <SideBar />
                                                    ...
                                                    return (
                                                        <div className="mt-3">
                                                            ...
                                                            <div className="col-sm-1">
                                                                <a className="btn btn-info " href="/carriere">choisir carriére</a>
                                                            </div>
                                                        </div>
                                                    )
                                            }
                        ...
                        <div className="col-md-8">
                                                    ...
                                                    <div className="card-body">
                                                        ...
                                                        <div className="row">
                                                            <div className="col-sm-12">
                                                                <a className="btn btn-info " href="/profil">Edit</a>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div className="row">
                                <div className="col-sm-12">
                                    <div className="card">
                                        <div className="card-body">
                                            <h3 className="d-flex align-items-center mb-3" >Niveau</h3>
                                            {posts.map((post,i) => {
                                                        ...
                                                        case 1:
                                                            return (
                                                                <div className={i}>
                                                                    <div className="row">
                                                                        <div className="col-sm-3">
                                                                            <h5 className="mb-0">{post.nomT}</h5>
                                                                        </div>
                                                                        <div className="col-sm-9 text-secondary">
                                                                            Pas de connaissance
                                                                        </div>
